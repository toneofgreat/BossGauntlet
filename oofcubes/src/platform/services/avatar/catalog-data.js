...
export const PLACE_REWARDS = [
  ...
  },
  {
    ...
    appearance: {
      prims: [
        { shape: "box", size: [1.06,0.3,0.58], offset: [0,0.5,0], rotation: [0,0,0],
          color: "#e9edf5", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.07,0.3,0.59], offset: [0,0.18,0], rotation: [0,0,0],
          color: "#1f3b8c", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.06,0.3,0.58], offset: [0,-0.14,0], rotation: [0,0,0],
          color: "#e9edf5", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.07,0.3,0.59], offset: [0,-0.46,0], rotation: [0,0,0],
          color: "#1f3b8c", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.08,0.12,0.6], offset: [0,0.68,0], rotation: [0,0,0],
  ...
  },
  {
    ...
    appearance: {
      prims: [
        { shape: "box", size: [1.06,1.5,0.58], offset: [0,0.05,0], rotation: [0,0,0],
          color: "#f2f2f2", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.78,0.14,0.04], offset: [0,-0.22,0.31], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.14,0.26,0.04], offset: [-0.39,-0.08,0.31], rotation: [0,0,28],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.14,0.26,0.04], offset: [0.39,-0.08,0.31], rotation: [0,0,-28],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.19,0.24,0.05], offset: [-0.25,0.4,0.31], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.19,0.24,0.05], offset: [0.25,0.4,0.31], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.46,0.06,0.04], offset: [0,0.64,0.31], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
      ],
      particles: null,
