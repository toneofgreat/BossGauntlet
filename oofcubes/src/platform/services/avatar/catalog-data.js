...
export const STARTER_CATALOG = [
  ...
  },
  {
    ...
    appearance: {
      prims: [
        { shape: "sphere", size: [0.3, 0.3, 0.3], offset: [0, -0.2, 0], rotation: [0, 0, 0],
          color: "#8c6a3f", material: "metal", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.16, 0.56, 0.16], offset: [0, 0.14, 0], rotation: [0, 0, 0],
          color: "#6b4423", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.19, 0.12, 0.19], offset: [0, 0, 0], rotation: [0, 0, 0],
          color: "#4a2f18", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.19, 0.12, 0.19], offset: [0, 0.28, 0], rotation: [0, 0, 0],
          color: "#4a2f18", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.98, 0.15, 0.22], offset: [0, 0.46, 0], rotation: [0, 0, 0],
          color: "#b98a4e", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.21, 0.21, 0.21], offset: [-0.49, 0.46, 0], rotation: [0, 0, 0],
          color: "#b98a4e", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.21, 0.21, 0.21], offset: [0.49, 0.46, 0], rotation: [0, 0, 0],
          color: "#b98a4e", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.22, 0.22, 0.22], offset: [0, 0.58, 0], rotation: [0, 0, 0],
          color: "#40c8ff", material: "neon", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.3, 2.3, 0.1], offset: [0, 1.68, 0], rotation: [0, 0, 0],
          color: "#d9b48f", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.1, 2, 0.12], offset: [0, 1.62, 0], rotation: [0, 0, 0],
          color: "#b08d68", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cone", size: [0.3, 0.5, 0.3], offset: [0, 3.08, 0], rotation: [0, 0, 0],
          color: "#d9b48f", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
      ],
      particles: null,
    },
  ...
  // ---- gear: §5.8's remaining four ---------------------------------------------------
  {
    ...
    appearance: {
      prims: [
        { shape: "sphere", size: [1.9, 2.2, 1.9], offset: [0, 2.7, 0], rotation: [0, 0, 0],
          color: "#d94436", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.5, 0.55, 0.5], offset: [-0.42, 3.15, -0.36], rotation: [0, 0, 0],
          color: "#ffffff", material: "plastic", transparency: 0.45, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.22, 0.24, 0.22], offset: [0.34, 3.3, -0.34], rotation: [0, 0, 0],
          color: "#ffffff", material: "plastic", transparency: 0.55, spin: 0, bob: null, flicker: null },
        { shape: "cone", size: [0.3, 0.34, 0.3], offset: [0, 1.5, 0], rotation: [180, 0, 0],
          color: "#b8382c", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.05, 0.56, 0.05], offset: [0, 1.12, 0], rotation: [0, 0, 0],
          color: "#e8ecf4", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.05, 0.56, 0.05], offset: [0.06, 0.58, 0], rotation: [0, 0, 8],
          color: "#e8ecf4", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.05, 0.5, 0.05], offset: [0.15, 0.08, 0], rotation: [0, 0, 15],
          color: "#e8ecf4", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.1, 0.42, 0.03], offset: [-0.11, 1.34, 0.06], rotation: [0, 0, -25],
          color: "#f7c948", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.1, 0.42, 0.03], offset: [0.13, 1.31, -0.06], rotation: [0, 0, 22],
          color: "#f7c948", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
      ],
      particles: null,
    },
  },
  {
    ...
    appearance: {
      prims: [
        { shape: "box", size: [0.86, 0.92, 0.32], offset: [0, 0.52, 0], rotation: [0, 0, 0],
          color: "#d94436", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.34, 2.05, 0.3], offset: [-0.1, 2, 0], rotation: [0, 0, 0],
          color: "#d94436", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.35, 0.38, 0.31], offset: [-0.1, 3, 0], rotation: [0, 0, 0],
          color: "#d94436", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.3, 0.44, 0.3], offset: [0.3, 1.02, 0], rotation: [0, 0, 0],
          color: "#c33d31", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.3, 0.44, 0.3], offset: [0.3, 0.64, 0], rotation: [0, 0, 0],
          color: "#c33d31", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.28, 0.4, 0.28], offset: [0.3, 0.28, 0], rotation: [0, 0, 0],
          color: "#c33d31", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.26, 0.52, 0.26], offset: [-0.5, 0.56, 0], rotation: [0, 0, 25],
          color: "#c33d31", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.62, 0.44, 0.05], offset: [0, 0.64, 0.19], rotation: [0, 0, 0],
          color: "#ffffff", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.92, 0.17, 0.36], offset: [0, 0.06, 0], rotation: [0, 0, 0],
          color: "#1f3b8c", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
      ],
      particles: null,
    },
  },
  {
    ...
    appearance: {
      prims: [
        { shape: "cylinder", size: [0.2, 2, 0.2], offset: [0, 0.85, 0], rotation: [0, 0, 0],
          color: "#6b4423", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.24, 0.15, 0.24], offset: [0, 0.25, 0], rotation: [0, 0, 0],
          color: "#3b2412", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.24, 0.15, 0.24], offset: [0, 1.35, 0], rotation: [0, 0, 0],
          color: "#3b2412", material: "wood", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.27, 0.13, 0.27], offset: [0, -0.16, 0], rotation: [0, 0, 0],
          color: "#8c8c8c", material: "metal", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cone", size: [0.64, 0.6, 0.64], offset: [0, 2.05, 0], rotation: [180, 0, 0],
          color: "#8c8c8c", material: "metal", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cone", size: [0.6, 1.05, 0.6], offset: [0, 2.72, 0], rotation: [0, 0, 0],
          color: "#ff9a1f", material: "neon", transparency: 0, spin: 0, bob: null, flicker: {"min":0.7,"max":1,"hz":7} },
        { shape: "cone", size: [0.42, 0.78, 0.42], offset: [0, 2.88, 0], rotation: [0, 0, 0],
          color: "#ffd93d", material: "neon", transparency: 0, spin: 0, bob: null, flicker: {"min":0.6,"max":1,"hz":11} },
        { shape: "cone", size: [0.23, 0.46, 0.23], offset: [0, 3.08, 0], rotation: [0, 0, 0],
          color: "#ffffff", material: "neon", transparency: 0, spin: 0, bob: null, flicker: {"min":0.5,"max":1,"hz":15} },
        { shape: "sphere", size: [0.16, 0.16, 0.16], offset: [0, 3.5, 0], rotation: [0, 0, 0],
          color: "#ff6a1f", material: "neon", transparency: 0, spin: 0, bob: {"amp":0.12,"hz":1.6}, flicker: null },
      ],
      particles: {
  ...
  },
  {
    ...
    appearance: {
      prims: [
        { shape: "box", size: [2.4, 1.3, 0.66], offset: [0, 0.9, 0], rotation: [0, 0, 0],
          color: "#2b2b30", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.3, 1.12, 0.06], offset: [0, 0.9, 0.34], rotation: [0, 0, 0],
          color: "#3a3a42", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.76, 0.1, 0.76], offset: [-0.65, 0.85, 0.38], rotation: [90, 0, 0],
          color: "#17171b", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.76, 0.1, 0.76], offset: [0.65, 0.85, 0.38], rotation: [90, 0, 0],
          color: "#17171b", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.35, 0.13, 0.35], offset: [-0.65, 0.85, 0.43], rotation: [90, 0, 0],
          color: "#55555f", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.35, 0.13, 0.35], offset: [0.65, 0.85, 0.43], rotation: [90, 0, 0],
          color: "#55555f", material: "plastic", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.64, 0.44, 0.06], offset: [0, 1.18, 0.37], rotation: [0, 0, 0],
          color: "#40c8ff", material: "glass", transparency: 0.35, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.17, 0.17, 0.17], offset: [-0.19, 0.46, 0.39], rotation: [0, 0, 0],
          color: "#ff7a1a", material: "neon", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.17, 0.17, 0.17], offset: [0.19, 0.46, 0.39], rotation: [0, 0, 0],
          color: "#ff7a1a", material: "neon", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.1, 0.56, 0.1], offset: [-0.85, 1.76, 0], rotation: [0, 0, 0],
          color: "#9aa0a6", material: "metal", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.1, 0.56, 0.1], offset: [0.85, 1.76, 0], rotation: [0, 0, 0],
          color: "#9aa0a6", material: "metal", transparency: 0, spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.86, 0.13, 0.13], offset: [0, 2.02, 0], rotation: [0, 0, 0],
          color: "#9aa0a6", material: "metal", transparency: 0, spin: 0, bob: null, flicker: null },
      ],
      particles: {
  ...
  // rainbow orbit of a dozen bright motes. ----------------------------------------------
  {
    ...
    price: 0, rarity: "rare", grantOnly: true, sourcePlace: "The Void crate",
    appearance: {
  ...
  },
  {
    ...
    price: 0, rarity: "epic", grantOnly: true, sourcePlace: "The Void crate",
    appearance: {
  ...
  },
  {
    ...
    price: 0, rarity: "legendary", grantOnly: true, sourcePlace: "The Void crate",
    appearance: {
  ...
  {
    // The best aura in the game — a blinding many-coloured core inside a fast twin ring
    // of a dozen-plus bright motes. Crate-only (grantOnly): shown in the Catalog, never
    // for sale.
...
export const PLACE_REWARDS = [
  ...
  // ---- 2026-09-02: the obby prize and the troll crate ------------------------------
  //
  // All `grantOnly` with no price: none is for sale. The bunny suit is what beating all
  // 93 obby stages gives you; the other two only come out of the troll crate, at the
  // odds spec 21 §4 pins.
  //
  // The crate's rarest drop is NOT a new party hat — `hat_party` and `aura_sparkle`
  // already exist and are buyable. Adding a second Party Hat would have been a
  // duplicate nobody could tell apart, so the 1-in-4500 is a distinct legendary that
  // ARRIVES WITH the sparkle aura and the balloon, which is what was asked for.
  {
    id: "hat_bunny", name: "Bunny Suit", type: "hat",
    price: 0, rarity: "legendary", grantOnly: true, sourcePlace: "obby",
    appearance: {
      prims: [
        { shape: "box", size: [1.06,0.34,1.06], offset: [0,0.14,0], rotation: [0,0,0],
          color: "#f7f2ee", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.34,0.34,0.34], offset: [0,0.22,-0.52], rotation: [0,0,0],
          color: "#fff6f2", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.26,1.5,0.26], offset: [-0.3,0.92,0.04], rotation: [0,0,-11],
          color: "#f7f2ee", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.26,1.5,0.26], offset: [0.3,0.92,0.04], rotation: [0,0,11],
          color: "#f7f2ee", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.15,1.14,0.15], offset: [-0.31,0.94,-0.02], rotation: [0,0,-11],
          color: "#ffb7c8", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.15,1.14,0.15], offset: [0.31,0.94,-0.02], rotation: [0,0,11],
          color: "#ffb7c8", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
  ...
  // Clothing geometry note (2026-09-05): the torso is 2 x 2 x 1 and the rig FACES -Z,
  // so a shirt wrap is ~2.06 x 1.9 x 1.06 and a chest decal sits at z <= -0.53. Both
  // original shirts were ~1.06 wide with +z decals — entirely INSIDE the torso, and so
  // invisible on every avatar that ever won one. Rule 20:G2 now rejects that.
  {
    id: "shirt_striped", name: "Striped Shirt", type: "shirt",
    price: 0, rarity: "common", grantOnly: true, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.06,0.48,1.06], offset: [0,0.66,0], rotation: [0,0,0],
          color: "#e9edf5", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.07,0.48,1.07], offset: [0,0.18,0], rotation: [0,0,0],
          color: "#1f3b8c", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.06,0.48,1.06], offset: [0,-0.3,0], rotation: [0,0,0],
          color: "#e9edf5", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.07,0.48,1.07], offset: [0,-0.78,0], rotation: [0,0,0],
          color: "#1f3b8c", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.1,0.14,1.1], offset: [0,0.92,0], rotation: [0,0,0],
          color: "#c9d2e4", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
      ],
      particles: null,
    },
  ...
  {
    id: "shirt_trollface", name: "Trollface Shirt", type: "shirt",
    price: 0, rarity: "uncommon", grantOnly: true, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.06,1.9,1.06], offset: [0,0,0], rotation: [0,0,0],
          color: "#f2f2f2", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.4,0.24,0.06], offset: [0,-0.42,-0.56], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.24,0.44,0.06], offset: [-0.72,-0.22,-0.56], rotation: [0,0,28],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.24,0.44,0.06], offset: [0.72,-0.22,-0.56], rotation: [0,0,-28],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.36,0.36,0.36], offset: [-0.45,0.42,-0.53], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.36,0.36,0.36], offset: [0.45,0.42,-0.53], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.85,0.1,0.06], offset: [0,0.78,-0.56], rotation: [0,0,0],
          color: "#141414", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
      ],
      particles: null,
  ...
  {
    id: "shirt_tee_red", name: "Red Tee", type: "shirt",
    price: 150, rarity: "common", grantOnly: false, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.06,1.9,1.06], offset: [0,0,0], rotation: [0,0,0],
          color: "#d23b2f", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.1,0.16,1.1], offset: [0,0.9,0], rotation: [0,0,0],
          color: "#ffffff", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.08,0.14,1.08], offset: [0,-0.88,0], rotation: [0,0,0],
          color: "#b52f24", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.4,0.4,0.4], offset: [0,0.3,-0.52], rotation: [0,0,0],
          color: "#ffd93d", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null },
      ],
      particles: null,
    },
  ...
  {
    id: "shirt_hoodie", name: "Cozy Hoodie", type: "shirt",
    price: 400, rarity: "uncommon", grantOnly: false, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.06,1.9,1.06], offset: [0,0,0], rotation: [0,0,0],
          color: "#8a93a6", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.2,0.5,0.1], offset: [0,-0.55,-0.57], rotation: [0,0,0],
          color: "#767f92", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.6,0.7,0.5], offset: [0,0.95,0.35], rotation: [12,0,0],
          color: "#767f92", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.08,0.5,0.08], offset: [-0.3,0.55,-0.56], rotation: [0,0,0],
          color: "#f2f4f6", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.08,0.5,0.08], offset: [0.3,0.55,-0.56], rotation: [0,0,0],
          color: "#f2f4f6", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.08,1.7,0.06], offset: [0,0,-0.565], rotation: [0,0,0],
          color: "#5b6373", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
      ],
      particles: null,
    },
  ...
  {
    id: "shirt_suit", name: "Fancy Suit Top", type: "shirt",
    price: 900, rarity: "rare", grantOnly: false, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.06,1.9,1.06], offset: [0,0,0], rotation: [0,0,0],
          color: "#23262e", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.9,1.75,0.08], offset: [0,0,-0.545], rotation: [0,0,0],
          color: "#f5f6f8", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.34,1.1,0.1], offset: [0,-0.1,-0.56], rotation: [0,0,0],
          color: "#c81e2e", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.44,0.28,0.12], offset: [0,0.62,-0.57], rotation: [0,0,0],
          color: "#c81e2e", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.5,0.9,0.08], offset: [-0.62,0.45,-0.55], rotation: [0,0,18],
          color: "#171a20", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [0.5,0.9,0.08], offset: [0.62,0.45,-0.55], rotation: [0,0,-18],
          color: "#171a20", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.12,0.12,0.12], offset: [-0.62,-0.2,-0.55], rotation: [0,0,0],
          color: "#d9b44a", material: "metal", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.12,0.12,0.12], offset: [-0.62,-0.6,-0.55], rotation: [0,0,0],
          color: "#d9b44a", material: "metal", transparency: 0,
          spin: 0, bob: null, flicker: null },
      ],
      particles: null,
  ...
  // Pants: default prims are torso-local (the hip band); a prim with
  // `limb: "leftLeg" | "rightLeg"` is leg-PIVOT-local (pivot at the hip, the leg
  // spanning y 0..-2 in a 1 x 2 x 1 box) and swings with the walk cycle.
  {
    id: "pants_jeans", name: "Blue Jeans", type: "pants",
    price: 150, rarity: "common", grantOnly: false, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.06,0.72,1.06], offset: [0,-0.66,0], rotation: [0,0,0],
          color: "#2c4f9c", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.1,0.16,1.1], offset: [0,-0.28,0], rotation: [0,0,0],
          color: "#6b4a2f", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.06,1.92,1.06], offset: [0,-0.98,0], rotation: [0,0,0],
          color: "#2c4f9c", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "leftLeg" },
        { shape: "box", size: [1.06,1.92,1.06], offset: [0,-0.98,0], rotation: [0,0,0],
          color: "#2c4f9c", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "rightLeg" },
        { shape: "box", size: [1.1,0.22,1.1], offset: [0,-1.86,0], rotation: [0,0,0],
          color: "#c9d2e4", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "leftLeg" },
        { shape: "box", size: [1.1,0.22,1.1], offset: [0,-1.86,0], rotation: [0,0,0],
          color: "#c9d2e4", material: "plastic", transparency: 0,
  ...
  {
    id: "pants_ninja", name: "Shadow Pants", type: "pants",
    price: 400, rarity: "uncommon", grantOnly: false, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.06,0.72,1.06], offset: [0,-0.66,0], rotation: [0,0,0],
          color: "#1b1d24", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.1,0.16,1.1], offset: [0,-0.28,0], rotation: [0,0,0],
          color: "#c81e2e", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null },
        ...
        { shape: "box", size: [1.06,1.92,1.06], offset: [0,-0.98,0], rotation: [0,0,0],
          color: "#1b1d24", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "rightLeg" },
        { shape: "box", size: [1.12,0.34,1.12], offset: [0,-1.7,0], rotation: [0,0,0],
          color: "#3a3f4d", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "leftLeg" },
        { shape: "box", size: [1.12,0.34,1.12], offset: [0,-1.7,0], rotation: [0,0,0],
          color: "#3a3f4d", material: "plastic", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "rightLeg" },
  ...
  {
    id: "pants_gold", name: "Golden Greaves", type: "pants",
    price: 900, rarity: "rare", grantOnly: false, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "box", size: [2.08,0.74,1.08], offset: [0,-0.66,0], rotation: [0,0,0],
          color: "#d9a622", material: "metal", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [2.12,0.18,1.12], offset: [0,-0.28,0], rotation: [0,0,0],
          color: "#8c6a12", material: "metal", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "box", size: [1.08,1.92,1.08], offset: [0,-0.98,0], rotation: [0,0,0],
          color: "#d9a622", material: "metal", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "leftLeg" },
        { shape: "box", size: [1.08,1.92,1.08], offset: [0,-0.98,0], rotation: [0,0,0],
          color: "#d9a622", material: "metal", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "rightLeg" },
        { shape: "sphere", size: [0.5,0.5,0.5], offset: [0,-0.95,-0.4], rotation: [0,0,0],
          color: "#f0c94a", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "leftLeg" },
        { shape: "sphere", size: [0.5,0.5,0.5], offset: [0,-0.95,-0.4], rotation: [0,0,0],
          color: "#f0c94a", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "rightLeg" },
        { shape: "box", size: [1.14,0.26,1.14], offset: [0,-1.84,0], rotation: [0,0,0],
          color: "#8c6a12", material: "metal", transparency: 0,
          spin: 0, bob: null, flicker: null, limb: "leftLeg" },
        { shape: "box", size: [1.14,0.26,1.14], offset: [0,-1.84,0], rotation: [0,0,0],
          color: "#8c6a12", material: "metal", transparency: 0,
  ...
  {
    id: "hat_trollcrown", name: "Troll Crown", type: "hat",
    price: 0, rarity: "legendary", grantOnly: true, sourcePlace: null,
    appearance: {
      prims: [
        { shape: "cylinder", size: [1,0.3,1], offset: [0,0.16,0], rotation: [0,0,0],
          color: "#ffd93d", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cone", size: [0.9,1.5,0.9], offset: [0,1,0], rotation: [0,0,0],
          color: "#ff36c8", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.72,0.16,0.72], offset: [0,0.55,0], rotation: [0,0,0],
          color: "#ffffff", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.5,0.16,0.5], offset: [0,1,0], rotation: [0,0,0],
          color: "#3ddc84", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "cylinder", size: [0.3,0.16,0.3], offset: [0,1.4,0], rotation: [0,0,0],
          color: "#0f5cc2", material: "neon", transparency: 0,
          spin: 0, bob: null, flicker: null },
        { shape: "sphere", size: [0.4,0.4,0.4], offset: [0,1.9,0], rotation: [0,0,0],
          color: "#ffffff", material: "neon", transparency: 0,
          spin: 0, bob: {"amp":0.08,"hz":1.2}, flicker: null },
      ],
      particles: null,
    },
  },
