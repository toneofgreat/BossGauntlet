...
function special(idx, name, color, order) {
  return Object.freeze({
    idx, name, color, count: 1, special: order, gauntlet: null,
...
export const DIFFS = Object.freeze([
  ...
  Object.freeze({
    ...
    idx: 19, name: "Megadeath", color: "#ff9e93", count: 3, special: 0, gauntlet: 88,
    p0: 48, p1: 52, gMin: 8, gMax: 8.5, size: 1.8,
    decoy: 0.35, spin: 24, head: true, beam: 1.5, checker: true, hug: true, glitch: false,
  }),
  Object.freeze({
    idx: 20, name: "Dilly Impossible", color: "#14000a", count: 2, special: 0, gauntlet: 90,
  ...
  Object.freeze({
    idx: 21, name: "Not Possible", color: "#ff36c8", count: 2, special: 0, gauntlet: 93,
...
// ---------------------------------------------------------------------------
// §5.3 ROSTER — all 93 stages, one row per stage: n, diff, name, theme, gauntlet, plats.
//
// `theme` and `plats` are §5.3's derivation, not a hand pick. Theme:
//   avail = themesFor(diff) (§5.6 order), off = (idx·3) % avail.length,
//   theme(s) = avail[(s−1+off) % avail.length]   — specials carry none.
// Budget: §5.2's formula over normals = count − (gauntlet ? 1 : 0),
//   normals === 1 ? p0 : round(p0 + (s−1)/(normals−1) · (p1−p0)),  gauntlets 2 × p1.
//
// **(Amended 2026-09-25 — THE TOWERS ARE GONE.** Fourteen stages used to be ToH-style
// TOWERS: a tall glass shell with a helix of rings inside it, one per difficulty from
// Medium up. They are GAUNTLETS now — the same stage numbers, the same 5 × p1 budgets and
// a 2× payout, generated as ordinary `mixed` stages, so the chart is 93 stages of
// obby and nothing else. Stage NUMBERING is untouched on purpose: a save holds the stage
// you reached, and renumbering would move every player's progress.
//
// A gauntlet is 2 × p1 platforms, not the tower's 5 ×, for two measured reasons: a
// 290-platform stage with its only checkpoint at the start is a punishment rather than a
// stage, and 08:R9 measured the live window at 1672 parts against MAX_LIVE_PARTS 1200
// when they were generated at tower length. Double length still makes it the longest
// stage of its difficulty by a distance. The payout follows the work: 2×, not 5×.**)
...
export const ROSTER = Object.freeze([
  Object.freeze({ n: 1, diff: "The Beginning", name: "The Beginning", theme: null, gauntlet: false, plats: null }),
  Object.freeze({ n: 2, diff: "Exist", name: "Exist", theme: null, gauntlet: false, plats: null }),
  Object.freeze({ n: 3, diff: "Just Jump", name: "Just Jump", theme: null, gauntlet: false, plats: null }),
  Object.freeze({ n: 4, diff: "Simply Walk", name: "Simply Walk", theme: null, gauntlet: false, plats: null }),
  Object.freeze({ n: 5, diff: "Walk Around It", name: "Walk Around It", theme: null, gauntlet: false, plats: null }),
  Object.freeze({ n: 6, diff: "Cake Walk", name: "Cake Walk 1", theme: "stairs", gauntlet: false, plats: 6 }),
  Object.freeze({ n: 7, diff: "Cake Walk", name: "Cake Walk 2", theme: "zigzag", gauntlet: false, plats: 7 }),
  Object.freeze({ n: 8, diff: "Cake Walk", name: "Cake Walk 3", theme: "tiny", gauntlet: false, plats: 7 }),
  Object.freeze({ n: 9, diff: "Cake Walk", name: "Cake Walk 4", theme: "longshot", gauntlet: false, plats: 8 }),
  Object.freeze({ n: 10, diff: "Cake Walk", name: "Cake Walk 5", theme: "walkrun", gauntlet: false, plats: 8 }),
  Object.freeze({ n: 11, diff: "Effortless", name: "Effortless 1", theme: "longshot", gauntlet: false, plats: 8 }),
  Object.freeze({ n: 12, diff: "Effortless", name: "Effortless 2", theme: "walkrun", gauntlet: false, plats: 9 }),
  Object.freeze({ n: 13, diff: "Effortless", name: "Effortless 3", theme: "mixed", gauntlet: false, plats: 9 }),
  Object.freeze({ n: 14, diff: "Effortless", name: "Effortless 4", theme: "jumps", gauntlet: false, plats: 10 }),
  Object.freeze({ n: 15, diff: "Effortless", name: "Effortless 5", theme: "stairs", gauntlet: false, plats: 10 }),
  Object.freeze({ n: 16, diff: "Easy", name: "Easy 1", theme: "walkrun", gauntlet: false, plats: 10 }),
  Object.freeze({ n: 17, diff: "Easy", name: "Easy 2", theme: "decoy", gauntlet: false, plats: 11 }),
  Object.freeze({ n: 18, diff: "Easy", name: "Easy 3", theme: "mixed", gauntlet: false, plats: 11 }),
  Object.freeze({ n: 19, diff: "Easy", name: "Easy 4", theme: "jumps", gauntlet: false, plats: 12 }),
  Object.freeze({ n: 20, diff: "Easy", name: "Easy 5", theme: "stairs", gauntlet: false, plats: 12 }),
  Object.freeze({ n: 21, diff: "Medium", name: "Medium 1", theme: "decoy", gauntlet: false, plats: 12 }),
  Object.freeze({ n: 22, diff: "Medium", name: "Medium 2", theme: "spin", gauntlet: false, plats: 13 }),
  Object.freeze({ n: 23, diff: "Medium", name: "Medium 3", theme: "mixed", gauntlet: false, plats: 13 }),
  Object.freeze({ n: 24, diff: "Medium", name: "Medium 4", theme: "jumps", gauntlet: false, plats: 14 }),
  Object.freeze({ n: 25, diff: "Medium", name: "Medium 5", theme: "stairs", gauntlet: false, plats: 14 }),
  Object.freeze({ n: 26, diff: "Medium", name: "Medium 6", theme: "zigzag", gauntlet: false, plats: 15 }),
  Object.freeze({ n: 27, diff: "Medium", name: "Medium 7", theme: "tiny", gauntlet: false, plats: 15 }),
  Object.freeze({ n: 28, diff: "Medium", name: "Medium 8", theme: "longshot", gauntlet: false, plats: 16 }),
  Object.freeze({ n: 29, diff: "Medium", name: "Medium 9", theme: "walkrun", gauntlet: false, plats: 16 }),
  Object.freeze({ n: 30, diff: "Medium", name: "Medium Gauntlet", theme: "mixed", gauntlet: true, plats: 32 }),
  Object.freeze({ n: 31, diff: "Hard", name: "Hard 1", theme: "spin", gauntlet: false, plats: 15 }),
  Object.freeze({ n: 32, diff: "Hard", name: "Hard 2", theme: "squeeze", gauntlet: false, plats: 16 }),
  Object.freeze({ n: 33, diff: "Hard", name: "Hard 3", theme: "mixed", gauntlet: false, plats: 17 }),
  Object.freeze({ n: 34, diff: "Hard", name: "Hard 4", theme: "jumps", gauntlet: false, plats: 18 }),
  Object.freeze({ n: 35, diff: "Hard", name: "Hard Gauntlet", theme: "mixed", gauntlet: true, plats: 36 }),
  Object.freeze({ n: 36, diff: "Difficult", name: "Difficult 1", theme: "squeeze", gauntlet: false, plats: 18 }),
  Object.freeze({ n: 37, diff: "Difficult", name: "Difficult 2", theme: "beams", gauntlet: false, plats: 19 }),
  Object.freeze({ n: 38, diff: "Difficult", name: "Difficult 3", theme: "mixed", gauntlet: false, plats: 20 }),
  Object.freeze({ n: 39, diff: "Difficult", name: "Difficult 4", theme: "jumps", gauntlet: false, plats: 21 }),
  Object.freeze({ n: 40, diff: "Difficult", name: "Difficult Gauntlet", theme: "mixed", gauntlet: true, plats: 42 }),
  Object.freeze({ n: 41, diff: "Challenging", name: "Challenging 1", theme: "beams", gauntlet: false, plats: 21 }),
  Object.freeze({ n: 42, diff: "Challenging", name: "Challenging 2", theme: "checker", gauntlet: false, plats: 22 }),
  Object.freeze({ n: 43, diff: "Challenging", name: "Challenging 3", theme: "mixed", gauntlet: false, plats: 23 }),
  Object.freeze({ n: 44, diff: "Challenging", name: "Challenging 4", theme: "jumps", gauntlet: false, plats: 24 }),
  Object.freeze({ n: 45, diff: "Challenging", name: "Challenging Gauntlet", theme: "mixed", gauntlet: true, plats: 48 }),
  Object.freeze({ n: 46, diff: "Intense", name: "Intense 1", theme: "jumps", gauntlet: false, plats: 24 }),
  Object.freeze({ n: 47, diff: "Intense", name: "Intense 2", theme: "stairs", gauntlet: false, plats: 25 }),
  Object.freeze({ n: 48, diff: "Intense", name: "Intense 3", theme: "zigzag", gauntlet: false, plats: 26 }),
  Object.freeze({ n: 49, diff: "Intense", name: "Intense 4", theme: "tiny", gauntlet: false, plats: 27 }),
  Object.freeze({ n: 50, diff: "Intense", name: "Intense Gauntlet", theme: "mixed", gauntlet: true, plats: 54 }),
  Object.freeze({ n: 51, diff: "Remorseless", name: "Remorseless 1", theme: "tiny", gauntlet: false, plats: 27 }),
  Object.freeze({ n: 52, diff: "Remorseless", name: "Remorseless 2", theme: "longshot", gauntlet: false, plats: 28 }),
  Object.freeze({ n: 53, diff: "Remorseless", name: "Remorseless 3", theme: "walkrun", gauntlet: false, plats: 29 }),
  Object.freeze({ n: 54, diff: "Remorseless", name: "Remorseless 4", theme: "decoy", gauntlet: false, plats: 30 }),
  Object.freeze({ n: 55, diff: "Remorseless", name: "Remorseless Gauntlet", theme: "mixed", gauntlet: true, plats: 60 }),
  Object.freeze({ n: 56, diff: "Insane", name: "Insane 1", theme: "decoy", gauntlet: false, plats: 30 }),
  Object.freeze({ n: 57, diff: "Insane", name: "Insane 2", theme: "spin", gauntlet: false, plats: 31 }),
  Object.freeze({ n: 58, diff: "Insane", name: "Insane 3", theme: "squeeze", gauntlet: false, plats: 32 }),
  Object.freeze({ n: 59, diff: "Insane", name: "Insane 4", theme: "beams", gauntlet: false, plats: 33 }),
  Object.freeze({ n: 60, diff: "Insane", name: "Insane Gauntlet", theme: "mixed", gauntlet: true, plats: 66 }),
  Object.freeze({ n: 61, diff: "Extreme", name: "Extreme 1", theme: "beams", gauntlet: false, plats: 33 }),
  Object.freeze({ n: 62, diff: "Extreme", name: "Extreme 2", theme: "checker", gauntlet: false, plats: 34 }),
  Object.freeze({ n: 63, diff: "Extreme", name: "Extreme 3", theme: "mixed", gauntlet: false, plats: 35 }),
  Object.freeze({ n: 64, diff: "Extreme", name: "Extreme 4", theme: "jumps", gauntlet: false, plats: 36 }),
  Object.freeze({ n: 65, diff: "Extreme", name: "Extreme Gauntlet", theme: "mixed", gauntlet: true, plats: 72 }),
  Object.freeze({ n: 66, diff: "Terrifying", name: "Terrifying 1", theme: "jumps", gauntlet: false, plats: 36 }),
  Object.freeze({ n: 67, diff: "Terrifying", name: "Terrifying 2", theme: "stairs", gauntlet: false, plats: 37 }),
  Object.freeze({ n: 68, diff: "Terrifying", name: "Terrifying 3", theme: "zigzag", gauntlet: false, plats: 37 }),
  Object.freeze({ n: 69, diff: "Terrifying", name: "Terrifying 4", theme: "tiny", gauntlet: false, plats: 38 }),
  Object.freeze({ n: 70, diff: "Terrifying", name: "Terrifying 5", theme: "longshot", gauntlet: false, plats: 38 }),
  Object.freeze({ n: 71, diff: "Terrifying", name: "Terrifying 6", theme: "walkrun", gauntlet: false, plats: 39 }),
  Object.freeze({ n: 72, diff: "Terrifying", name: "Terrifying 7", theme: "decoy", gauntlet: false, plats: 39 }),
  Object.freeze({ n: 73, diff: "Terrifying", name: "Terrifying 8", theme: "spin", gauntlet: false, plats: 40 }),
  Object.freeze({ n: 74, diff: "Terrifying", name: "Terrifying 9", theme: "squeeze", gauntlet: false, plats: 40 }),
  Object.freeze({ n: 75, diff: "Terrifying", name: "Terrifying Gauntlet", theme: "mixed", gauntlet: true, plats: 80 }),
  Object.freeze({ n: 76, diff: "Catastrophic", name: "Catastrophic 1", theme: "tiny", gauntlet: false, plats: 40 }),
  Object.freeze({ n: 77, diff: "Catastrophic", name: "Catastrophic 2", theme: "longshot", gauntlet: false, plats: 41 }),
  Object.freeze({ n: 78, diff: "Catastrophic", name: "Catastrophic 3", theme: "walkrun", gauntlet: false, plats: 43 }),
  Object.freeze({ n: 79, diff: "Catastrophic", name: "Catastrophic 4", theme: "decoy", gauntlet: false, plats: 44 }),
  Object.freeze({ n: 80, diff: "Catastrophic", name: "Catastrophic Gauntlet", theme: "mixed", gauntlet: true, plats: 88 }),
  Object.freeze({ n: 81, diff: "NIL", name: "NIL 1", theme: "decoy", gauntlet: false, plats: 44 }),
  Object.freeze({ n: 82, diff: "NIL", name: "NIL 2", theme: "spin", gauntlet: false, plats: 45 }),
  Object.freeze({ n: 83, diff: "NIL", name: "NIL 3", theme: "squeeze", gauntlet: false, plats: 47 }),
  Object.freeze({ n: 84, diff: "NIL", name: "NIL 4", theme: "beams", gauntlet: false, plats: 48 }),
  Object.freeze({ n: 85, diff: "NIL", name: "NIL Gauntlet", theme: "mixed", gauntlet: true, plats: 96 }),
  Object.freeze({ n: 86, diff: "Megadeath", name: "Megadeath 1", theme: "beams", gauntlet: false, plats: 48 }),
  Object.freeze({ n: 87, diff: "Megadeath", name: "Megadeath 2", theme: "checker", gauntlet: false, plats: 52 }),
  Object.freeze({ n: 88, diff: "Megadeath", name: "Megadeath Gauntlet", theme: "mixed", gauntlet: true, plats: 104 }),
  Object.freeze({ n: 89, diff: "Dilly Impossible", name: "Dilly Impossible 1", theme: "jumps", gauntlet: false, plats: 55 }),
  Object.freeze({ n: 90, diff: "Dilly Impossible", name: "Dilly Impossible Gauntlet", theme: "mixed", gauntlet: true, plats: 110 }),
  Object.freeze({ n: 91, diff: "Not Possible", name: "Not Possible 1", theme: "wrap", gauntlet: false, plats: 58 }),
  Object.freeze({ n: 92, diff: "Not Possible", name: "Not Possible 2", theme: "mixed", gauntlet: false, plats: 58 }),
  Object.freeze({ n: 93, diff: "Not Possible", name: "Not Possible Gauntlet", theme: "mixed", gauntlet: true, plats: 116 }),
]);
...
export const KIND_MAP = Object.freeze({
  ...
  // §5.14's scenery kinds (added 2026-09-25). `prop` and `propGlow` take their SHAPE from
  // the part itself rather than from the kind — one kind per shape would be nine rows of
  // the same thing — and `propGlow`/`lampGlow` carry a `light`, which is what makes the
  // chart lit by the chart instead of only by its sun (spec 03 §5.1b).
  lampPost: Object.freeze({ shape: "cylinder", material: "metal", color: "#5c6478", t: 0 }),
  lampGlow: Object.freeze({
    shape: "sphere", material: "neon", color: "#ffe6a8", t: 0, canCollide: false,
    light: Object.freeze({ intensity: 1.8, range: 30 }),
  }),
  prop: Object.freeze({ shape: "box", material: "plastic", diffColor: true, t: 0, canCollide: false }),
  propGlow: Object.freeze({
    shape: "sphere", material: "neon", diffColor: true, t: 0.15, canCollide: false,
    light: Object.freeze({ intensity: 1.4, range: 24 }),
  }),
...
// ---------------------------------------------------------------------------
// §5.9.6 REWARDS — Oofbux per first-time stage completion (gauntlets pay 2×, applied by
