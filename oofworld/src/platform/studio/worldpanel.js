...
export const STUDIO_LIGHTING_PRESETS = Object.freeze({
  ...
  // Six more, appended 2026-09-25 (§5.6.5 amended). Same rule as the first six: a whole
  // world's mood per card, no raw fields. They are ordered after the originals so the
  // six anyone has already used stay exactly where they were on the panel.
  dawn: {
    skyTop: "#3b2d63", skyBottom: "#ffc4a3", ambient: "#a98fb0",
    ambientIntensity: 0.75, sunColor: "#ffd9a8", sunIntensity: 0.9,
    sunDirection: [0.4, -0.35, -0.5], fog: { color: "#e0a07a", near: 140, far: 430 },
  },
  storm: {
    skyTop: "#232a33", skyBottom: "#4d5661", ambient: "#5a6472",
    ambientIntensity: 0.55, sunColor: "#9fb0c8", sunIntensity: 0.4,
    sunDirection: [-0.6, -1, -0.1], fog: { color: "#39414b", near: 50, far: 200 },
  },
  alien: {
    skyTop: "#0f2b1d", skyBottom: "#7ef2a0", ambient: "#5fd68f",
    ambientIntensity: 0.8, sunColor: "#c9ff8a", sunIntensity: 0.9,
    sunDirection: [-0.35, -0.9, 0.4], fog: { color: "#2a6b45", near: 110, far: 340 },
  },
  space: {
    skyTop: "#04060f", skyBottom: "#0b1026", ambient: "#2b3350",
    ambientIntensity: 0.35, sunColor: "#ffffff", sunIntensity: 1.6,
    sunDirection: [-0.7, -0.6, -0.4], fog: null,
  },
  neon: {
    skyTop: "#150826", skyBottom: "#3b0f4d", ambient: "#6a2f8f",
    ambientIntensity: 0.6, sunColor: "#ff6ad5", sunIntensity: 0.5,
    sunDirection: [-0.2, -1, -0.5], fog: { color: "#2a0b3d", near: 70, far: 240 },
  },
  candy: {
    skyTop: "#ffb3e6", skyBottom: "#fff0f7", ambient: "#ffd6ef",
    ambientIntensity: 1.0, sunColor: "#fff4fa", sunIntensity: 1.2,
    sunDirection: [-0.4, -1, -0.3], fog: { color: "#ffd9f0", near: 160, far: 520 },
  },
});
...
const PRESET_NAMES = {
  day: "Day", sunset: "Sunset", night: "Night", overcast: "Overcast", lava: "Lava", ice: "Ice",
  dawn: "Dawn", storm: "Storm", alien: "Alien", space: "Space", neon: "Neon", candy: "Candy",
};
const PRESET_ORDER = [
  "day", "sunset", "night", "overcast", "lava", "ice",
  "dawn", "storm", "alien", "space", "neon", "candy",
];
...
// Every track the engine has (spec 02 §5.5.10's TRACKS), not the four Studio shipped
// with: the other three were written for Places (chill/clash/voidchill) and a share code
// can carry them now that pack.js's MUSIC_IDS lists them too. Appended, never reordered —
// pack.js encodes a track as its index.
const TRACKS = [
  { id: null, label: "None" },
