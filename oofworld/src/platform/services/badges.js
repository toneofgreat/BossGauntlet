...
export const BADGES = Object.freeze([
  ...
  B("oof.welcome", "Welcome Oofer", "👋", "Boot OofWorld for the first time."),
  ...
  B("hub.brickclimber", "Brick Legend", "🧱", "Beat the Brick Climb behind the plaza's brick gate."),
  ...
  B("obby.medium", "Medium Rare", "🟡", "Clear the Medium Gauntlet."),
  B("obby.hard", "Hard Hat", "🟠", "Clear the Hard Gauntlet."),
  B("obby.difficult", "Difficult Days", "🔴", "Clear the Difficult Gauntlet."),
  B("obby.challenging", "Challenge Accepted", "🟥", "Clear the Challenging Gauntlet."),
  B("obby.intense", "Intense Focus", "🔥", "Clear the Intense Gauntlet."),
  B("obby.remorseless", "No Remorse", "💜", "Clear the Remorseless Gauntlet."),
  B("obby.insane", "Certified Insane", "🔵", "Clear the Insane Gauntlet."),
  B("obby.extreme", "Extreme Machine", "🧊", "Clear the Extreme Gauntlet."),
  B("obby.terrifying", "Fear Is Fake", "👻", "Clear the Terrifying Gauntlet."),
  B("obby.catastrophic", "Catastrophe Averted", "⚪", "Clear the Catastrophic Gauntlet."),
  B("obby.nil", "Undefined Behavior", "🌫️", "Clear the NIL Gauntlet."),
  B("obby.megadeath", "Megadeath Survivor", "💀", "Clear the Megadeath Gauntlet."),
  B("obby.dilly", "Dilly Impossible??", "🌈", "Clear the Dilly Impossible Gauntlet."),
