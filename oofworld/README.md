...
OofWorld is not "a game." It is a **platform** that ships with games:
...
1. **Difficulty Chart Obby** — 93 stages, checkpoints, stage select. (The fourteen ToH-style TOWERS came out on 2026-09-25; those stages are long `mixed` gauntlets now.)
