// Assembles roblox-tycoon/src/*.lua into BossTycoon.rbxlx and syntax-checks every file.
// Usage: node build.js [--check-only]
const fs = require('fs');
const path = require('path');

const SCRATCH = 'C:/Users/krist/AppData/Local/Temp/claude/C--Users-krist-Desktop-BossGauntlet/057bbecb-cae7-4681-8fec-e764359e636c/scratchpad';
const luaparse = require(path.join(SCRATCH, 'node_modules', 'luaparse'));

const SRC = path.join(__dirname, 'src');
const OUT = path.join(__dirname, 'BossTycoon.rbxlx');
const DESKTOP_OUT = 'C:/Users/krist/Desktop/BossTycoon.rbxlx';

const MODULES = [
  'Util', 'Economy', 'Lobby', 'PlotManager', 'Purchases', 'Balance', 'ItemsCore',
  'ItemsMain', 'ItemsUpper', 'Obbies', 'Lab', 'UpperFloors', 'TrollObby', 'Endgame',
];
...
${scriptItem('Script', 'TycoonMain', main, moduleItems)}
</Item>
...
${scriptItem('LocalScript', 'TycoonClient', client)}
</Item>
</Item>
</roblox>
`;
